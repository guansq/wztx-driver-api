      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "list.org_address_detail",
            "description": "<p>发货人地址详情</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "list.dest_address_detail",
        ...
        "Parameter": [
          {
            ...
            "description": "<p>物流类型 1：同城物流 2：长途物流 0:所有</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "auth_status",
            "description": "<p>认证状态（init=未认证，check=认证中，pass=认证通过，refuse=认证失败, reauth=重新审核）</p>"
          }
        ]
      }
    },
